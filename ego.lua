...
Text = "Join the discord for support.", 
...
KillingCheats:CreateButton("Vitalware: vitality#2332", function()
game:GetService("StarterGui"):SetCore("SendNotification",{
Title = "Discord User Copied",
...
KillingCheats:CreateButton("Original: Maikderninja", function()
game:GetService("StarterGui"):SetCore("SendNotification",{
