...
Color = Info
    ...
    function library:AddWindow(text,keybind)
		...
		Main.BorderColor3 = Color3.fromRGB(254, 197, 229)
		...
		Top.BorderColor3 = Color3.fromRGB(254, 197, 229)
		...
		Page.BorderColor3 = Color3.fromRGB(254, 197, 229)
        ...
        function uitab:AddTab(text,image)
            ...
            PageButton.MouseButton1Click:Connect(function()
                ...
                for i,v in next, ScrollPage:GetChildren() do 
                    ...
                    TweenService:Create(
                        PageButton,
                        TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
                        {TextColor3 = Color3.fromRGB(254,197,229)}
                    ):Play()
                end
            end)
            ...
            function main:AddButton(text,callback)
                ...
                Button.Text = text
                Button.TextColor3 = Color3.fromRGB(254, 197, 229)
                ...
                Button.MouseEnter:Connect(function()
                    TweenService:Create(
                        ...
                        {TextColor3 = Color3.fromRGB(254,128,199)}
                    ):Play()
                end)
            ...
            function main:AddToggle(text,config,callback)
                ...
                Toggle.Text = ""
                Toggle.TextColor3 = Color3.fromRGB(254, 197, 229)
                ...
                ToggleLabel.TextColor3 = Color3.fromRGB(254, 197, 229)
                ...
                ToggleImage2.BackgroundColor3 = Color3.fromRGB(254,197,229)
                ...
                Toggle.MouseLeave:Connect(function()
                    TweenService:Create(
                        ToggleLabel,
                        TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
                        {TextColor3 = Color3.fromRGB(224, 197, 229)}
                    ):Play()
                end)
            ...
            function main:AddSeperator(text)
                ...
                Sep1.BackgroundColor3 = Color3.fromRGB(254,197,229)
                ...
                Sep2.BackgroundColor3 = Color3.fromRGB(254,197,229)
            ...
            function main:AddLine()
                ...
                Line.BackgroundColor3 = Color3.fromRGB(254, 197, 229)
                ...
                Linee.Name = "Linee"
                Linee.Parent = Line
                Linee.BackgroundColor3 = Color3.fromRGB(254,197,229)
            ...
            function main:AddLabel(text)
                ...
                Label.TextColor3 = Color3.fromRGB(254, 197, 229)
    ...
    function UpdateTime()
        ...
        Time:Set("Time Used: Hr(s) : "..Hour.." Min(s) : "..Minute.." Sec(s) : "..Second)
    end
  ...
  Main:AddButton("Destroy GUI", function()
	...
	Main:AddSeperator("Graphics")

  Main:AddButton("Fps Unlock", function()
game:GetService("StarterGui"):SetCore("SendNotification",{
Title = "Fps Unlocked",
...
loadstring(game:HttpGet(('https://raw.githubusercontent.com/qwerty-lol/redeem-all-codes/main/redeem%20every%20code%20script.lua'),true))()
	...
	--------------------------------------------------------------------
Combat:AddSeperator("Main")
	
Combat:AddToggle("Aimbot",false,function(aimbot)
local Players = game:GetService("Players")
...
function Circle()
    ...
    circ.Thickness = 1.5
    circ.Visible = true
    circ.Color = Color3.fromRGB(40,90,255)
	circ.Filled = false
	circ.NumSides = 150
...
Visuals:AddLabel("")
local Current = Visuals:AddLabel("Toggleable will be added soon.")
Visuals:AddLabel("")

	--------------------------------------------------------------------
GunMods:AddSeperator("Mods")
...
game:GetService("StarterGui"):SetCore("SendNotification",{
Title = "Shader GUI Enabled",
Text = "Sorry, no toggle for this so, rejoin if you don't like it.", 

Duration = 5
})
loadstring(game:HttpGet(('https://raw.githubusercontent.com/veinlol/Scripts/main/shadergui.lua'),true))()
end)
